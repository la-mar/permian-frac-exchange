...
def connect_db():
    ...
    cnxn = {}
    cnxn["engine"] = create_engine(URL(**DATABASE_URL_PARAMS))
...
# TODO: Remove most of this class
...
# TODO: Re-add calculated columns
...
# # TODO: Remove to avoid geopandas on windows
